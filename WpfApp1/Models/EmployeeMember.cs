...
namespace WpfApp1.Models
{
    ...
    public class EmployeeMember : Member, IEmployee
    {
        private const string AuthorsFilePath = "authorsEmployeeMemberExtension.json";
        private const string LibraryObjectsFilePath = "library_objectsEmployeeMemberExtension.json";
        private const string BooksFilePath = "booksEmployeeMemberExtension.json";

        public EmployeeMember(Human human, string membershipID) : base(human, membershipID)
        {
            Human = human;
